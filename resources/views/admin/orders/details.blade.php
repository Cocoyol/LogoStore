            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li role="presentation" class="active"><a href="#!">Requerimientos Adicionales</a></li>
                        </ul>
                        <table class="table table-striped">
                            <?php $additionals = $order->additionalRequirements; ?>
                            @foreach($additionals as $additional)
                                <tr>
                                    <td><ul><li>{{ $additional->additionalRequirementsPrice->text }}:<br/>{{ $additional->data }}</li></ul></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
